...
return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => $this->getEnv('DATABASE_HOST'), 'port' => $this->getEnv('DATABASE_PORT'), 'dbname' => $this->getEnv('MYSQL_DATABASE'), 'user' => $this->getEnv('MYSQL_USER'), 'password' => $this->getEnv('MYSQL_PASSWORD'), 'charset' => 'UTF8', 'driverOptions' => [], 'defaultTableOptions' => []], $a, $c, []);
